...
var updateCounts = function() {
  if(gameActive) {
    ...
    setStat(game, "total-count", total);
    setStat(game, "max-count", max);
    setStat(game, "average-count", avg);
...
var startGame = function() {
  ...
  addHandler(game, function(points) {
    me.score += points;
