...
(defn render-config []
  [[:node-create [:main] add-template]
   ...
   [:node-create [:main :my-counter] add-player]
   [:node-create [:main :other-counters :*] add-player]
   [:value [:main :my-counter] set-score]
   [:value [:main :other-counters :*] set-score]
